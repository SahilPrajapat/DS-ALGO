...
public class linkedlist {
    ...
    private void IndexOutofBondSizeExclusiveException(int idx) throws Exception{
        if(idx < 0 || idx >= this.sizeOfLL)
            throw new Exception("Index out of bond");
    }

    private void IndexOutofBondSizeInclusiveException(int idx) throws Exception{
        if(idx < 0 || idx > this.sizeOfLL)
            throw new Exception("Index out of bond");
    }
    ...
    public int getAt(int idx) throws Exception {
        IndexOutofBondSizeExclusiveException(idx);
    ...
    public void addAt(int idx, int data) throws Exception{
        IndexOutofBondSizeInclusiveException(idx);
        Node node = new Node(data);
        addAtNode(idx, node);
    }
