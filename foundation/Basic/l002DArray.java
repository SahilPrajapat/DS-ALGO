...
public class l002DArray {
    ...
    // one more display function but it is only for read and above is for read and write
    ...
    public static void waveTravelLiftRight(int[][] arr){
        int n = arr.length;
        int m = arr[0].length;
    ...
    public static void waveTravelUpdown(int[][] arr){
        int n = arr.length;
        int m = arr[0].length;
    ...
    public static void digonalTravel(int[][] arr){
        int n = arr.length;
        int m = arr[0].length;
